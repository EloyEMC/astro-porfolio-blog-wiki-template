...
faqs:
  ...
  - question: "¿Qué electrodomésticos llevarán la nueva etiqueta energética?"
    answer: "Neveras, congeladores, lavadoras, lavavajillas, secadoras, pantallas electrónicas (TV y monitores), fuentes de iluminación (desde septiembre 2021) y aires acondicionados (desde 2022)."

  - question: "¿Qué pasará con los electrodomésticos que eran A+++?"
    answer: "Bajarán de categoría debido a los nuevos límites más estrictos. Un aparato que era A+++ podría pasar a ser clase B o C en la nueva escala."

  - question: "¿Hasta cuándo podré ver ambas etiquetas en las tiendas?"
    answer: "Las tiendas pueden vender productos con la etiqueta antigua hasta agotar existencias, pero desde marzo 2021 ya deben mostrar la nueva etiqueta en lavadoras, frigoríficos y otros electrodomésticos clave."

  - question: "¿Qué información incluye la nueva etiqueta energética?"
    answer: "Incluye la clase energética (A-G), consumo anual de energía, pictogramas con datos técnicos como capacidad y ruido, y un código QR para acceder a más información en la base de datos EPREL de la UE."

  - question: "¿Cómo afecta el cambio al consumo real de mis electrodomésticos?"
    answer: "El consumo real no cambia, solo la clasificación. Los nuevos tests son más realistas (como el programa 'Eco 40-60' en lavadoras) y los límites para cada clase son más exigentes."

  - question: "¿Dónde puedo comparar el consumo de diferentes electrodomésticos?"
    answer: "Puedes escanear el código QR de la etiqueta, consultar la base de datos europea EPREL o usar la calculadora del proyecto BELT en belt-project.eu/belt."

  - question: "¿Qué es el proyecto BELT?"
    answer: "Una iniciativa europea que informa a consumidores y fabricantes sobre el cambio de etiquetas, fomenta la compra de productos eficientes y apoya la innovación en electrodomésticos."

  - question: "¿Por qué la clase A está vacía inicialmente?"
    answer: "Se dejó vacía para permitir el desarrollo de tecnologías más eficientes en el futuro, manteniendo espacio para mejoras en la escala energética."

  - question: "¿Las nuevas etiquetas afectan a todos los países de la UE?"
    answer: "Sí, el cambio es aplicable en todos los países miembros de la Unión Europea y sigue el Reglamento UE 2017/1369."
...
Estos son [los electrodomésticos donde se aplicaran las nuevas etiquetas](https://amzn.to/3sT29zv) se aplicarán en neveras, congeladores, refrigeradores para bebidas o vino, lavavajillas, lavadoras y lavadoras, secadoras, pantallas electrónicas (monitores, televisiones..) y fuentes de iluminación (lámparas), en este último caso desde el 1 de septiembre.
...
![](/nueva-etiqueta-energetica-2021-2-1024x554.webp)
...
La gran novedad es que incorporarán [un código QR que permite acceder a más información sobre el aparato desde los teléfonos móviles](https://www.belt-project.eu/). En ventas online o folletos, la letra se indicará en una flecha y poniendo qué máximos y mínimos hay en la escala.

## El proyecto Belt

<a href="https://youtu.be/QJhoP4eeVNA" target="_blank" class="inline-block relative w-[100%] h-auto border-4 border-gray-300 rounded-lg overflow-hidden">
  <img src="https://img.youtube.com/vi/QJhoP4eeVNA/0.jpg" alt="Video sobre las hormonas de la felicidad" class="w-full h-full block aspect-video">
...
[![](/Captura-de-pantalla-2021-03-04-a-las-12.00.10.webp)](/Captura-de-pantalla-2021-03-04-a-las-12.00.10.webp)
...
[Calculadora proyecto BELT](https://www.belt-project.eu/belt)

## FAQs sobre la Nueva Etiqueta Energética 2021

1. ¿Por qué cambia la etiqueta energética en 2021?
...
5. ¿Qué información incluye la nueva etiqueta?
Clase energética (A-G) con colores (verde a rojo).
...
7. ¿Dónde puedo comparar el consumo de electrodomésticos?
  ...
  Escaneando el código QR de la etiqueta o consultando la base de datos europea EPREL. También puedes usar la calculadora del proyecto BELT:
  👉 [Calculadora de consumo BELT](#el-proyecto-belt)
