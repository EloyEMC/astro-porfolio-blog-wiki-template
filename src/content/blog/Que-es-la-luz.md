...
faqs:
  - question: "¿Qué es la luz?"
    answer: "La luz es radiación electromagnética; en el uso cotidiano de la iluminación, hablamos sobre todo de la parte visible para el ojo humano. Su descripción física combina comportamiento ondulatorio y cuantos de energía llamados fotones."
  - question: "¿Qué diferencia hay entre el espectro visible y la distribución espectral de potencia?"
    answer: "El espectro visible es el intervalo de radiación que puede detectar el ojo humano. La distribución espectral de potencia (SPD) muestra cómo se reparte la potencia radiada de una fuente entre distintas longitudes de onda."
  - question: "¿Qué diferencia hay entre reflexión especular y difusa?"
    answer: "La reflexión especular conserva una dirección predominante, como en un espejo; la reflexión difusa dispersa la luz en varias direcciones, como ocurre en una pared mate. Una superficie real puede combinar ambos comportamientos."
  - question: "¿Qué es la refracción de la luz?"
    answer: "La refracción es el cambio de dirección y velocidad que puede experimentar la luz al pasar de un medio a otro. La magnitud del cambio depende de los índices de refracción y del ángulo de incidencia."
  - question: "¿Para qué sirven DIALux y Relux?"
    answer: "DIALux y Relux son programas de cálculo lumínico que permiten simular la distribución de la luz de luminarias y verificar niveles, uniformidad y otros resultados fotométricos en un espacio."
  - question: "¿Por qué es importante entender la luz en iluminación?"
...
Para una introducción física rigurosa, consulta [la explicación de OpenStax sobre la naturaleza ondulatoria y corpuscular de la luz](https://openstax.org/books/physics/pages/21-3-the-dual-nature-of-light).
...
El [Departamento de Energía de Estados Unidos explica las fuentes de luz y el espectro electromagnético](https://www.energy.gov/science/doe-explainslight-sources), una referencia útil para ampliar esta parte sin confundir radiación visible con todo el espectro.

<aside class="lighting-application">
<p class="lighting-application__eyebrow">APLICACIÓN / ILUMINACIÓN</p>
<p class="lighting-application__title">¿Por qué importa en iluminación?</p>
<p>Al comparar luminarias, la SPD ayuda a entender qué radiación emiten. Después conviene contrastarla con los datos fotométricos y colorimétricos declarados por el fabricante, no inferir el comportamiento solo por la apariencia de la lámpara.</p>
</aside>
...
![Curva fotométrica de una luminaria](/que-es-la-luz-curva-fotometrica.webp)
...
![Ejemplo visual de reflexión y refracción](/Que-es-la-luz-caracteristicas-refracion.webp)
...
<p class="lighting-application__eyebrow">APLICACIÓN / ILUMINACIÓN</p>
<p class="lighting-application__title">¿Por qué importa en iluminación?</p>
<p>El acabado y el color de techo, paredes, suelo y mobiliario cambian la luz reflejada. Una superficie clara y mate puede ayudar a repartirla; una brillante puede introducir reflejos y luminancias molestas.</p>
</aside>
...
![Ejemplo de refracción de la luz](/que-es-la-luz-propiedad-de-Refracion-224x300.webp)

<details>
<summary>Bloque técnico opcional: ley de Snell</summary>
...
<p class="lighting-application__eyebrow">APLICACIÓN / ILUMINACIÓN</p>
<p class="lighting-application__title">¿Por qué importa en iluminación?</p>
<p>Lentes y reflectores aprovechan reflexión y refracción para controlar la apertura, el alcance y la distribución de una luminaria. El objetivo no es “crear” más luz, sino llevarla a donde hace falta con menos pérdidas y molestias.</p>
</aside>
...
- ¿La SPD y las características de color son coherentes con la experiencia buscada? La [temperatura de color](/blog/qué-es-la-temperatura-de-color/) ayuda a describir una parte de esa decisión.
- ¿El cálculo en DIALux o Relux coincide con la instalación, el mantenimiento y el consumo previstos? En determinados proyectos también conviene considerar el [ritmo circadiano y el HCL](/blog/qué-es-el-ritmo-circadiano-y-el-hcl/).

<p class="lighting-application__conclusion">La física explica el fenómeno.<br />La experiencia permite convertirlo en una decisión de proyecto.</p>

Para seguir el proceso desde la práctica, puedes consultar la sección de [iluminación profesional](https://eloymartinezcuesta.com/iluminacion/) y el archivo de [artículos sobre iluminación y tecnología](https://eloymartinezcuesta.com/articulos/).
...
- [OpenStax: naturaleza ondulatoria y corpuscular de la luz](https://openstax.org/books/physics/pages/21-3-the-dual-nature-of-light).
- [OpenStax: reflexión](https://openstax.org/books/physics/pages/16-1-reflection).
- [OpenStax: refracción y ley de Snell](https://openstax.org/books/physics/pages/16-2-refraction).
- [Departamento de Energía de Estados Unidos: fuentes de luz y espectro electromagnético](https://www.energy.gov/science/doe-explainslight-sources).
